...
urlpatterns = [
    ...
    path('frequenciaCoord/<int:id_aula>', views.frequencia_Coordenacao, name='frequenciaCoord'),
    ...
    path('alunos/<int:id_turma>', views.lista_alunos, name='lista_alunos'),
    path('pei_realizar/<int:id_usuario>', views.realizar_pei, name='realizar_pei'),
    path('pei_detalhes/<int:id_usuario>', views.pei_detalhes, name='pei_detalhes'),
    path('pei_editar/', views.editar_pei, name='pei_editar'),
    path('pei_registrar/', views.registrar_pei, name='registrar_pei'),
]
